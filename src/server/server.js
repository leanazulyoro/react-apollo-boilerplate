...
import serverRenderMiddleware from './middleware/serverRenderMiddleware';
import yn from "yn";
...
import clientRenderMiddleware from './middleware/clientRenderMiddleware';
import cacheConfigMiddleware from './middleware/cacheConfigMiddleware';
...
let server = (new ServerBuilder())
  ...
  .withMiddleWare(cacheConfigMiddleware);
...
server.withMiddleWare(serverRenderMiddleware);
server.withMiddleWare(clientRenderMiddleware);
